 ...
 function Men() {
  ...
  const [rec,setRec] = useState([]);
    const GetCategories= async (id) => {
        const { data } = await axios.get(`http://clothes/product/getCat.php?gender=men`);
        return data;
      };
      ...
      const ProductsRec= async (id) => {
        const { data } = await axios.get(`http://clothes/product/getProductsRec.php?gender=male`);
        return data;
      };
      ...
      const {data:productData,isSuccess:productSuccess,error:productError} = GetData(Products,'getManProduct');
          ...
          <div className="Product_container">
            ...
            <div className="Man_products">
              <div className="Title_box">
                <div className="Name_box"><h1>Men’s Clothing</h1></div>
